...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container">
      <router-link class="navbar-brand" to="/">
        <img src="https://uxwing.com/wp-content/themes/uxwing/download/20-food-and-drinks/meal-food.png" alt="logo" width="50px">
      </router-link>
    <button 
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <router-link class="nav-link" to="/keranjang">
            ...
            <span class="badge badge-success">{{ keranjang_pesanan.length }}</span>
          </router-link>
        </li> 
      </ul>
    </div>
